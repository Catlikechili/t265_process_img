...
D_left = np.array([-0.001190, 0.037810, -0.035387, 0.005361], dtype=np.float32)

K_right = np.array([
    [284.981995, 0.000000, 428.147308],
    [0.000000, 286.101807, 405.857910],
    [0.000000, 0.000000, 1.000000]
], dtype=np.float32)

D_right = np.array([-0.000164, 0.036114, -0.033729, 0.004820], dtype=np.float32)
